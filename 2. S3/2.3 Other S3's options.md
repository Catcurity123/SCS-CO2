...
#### E. S3 Access Points
(+) Resource Policy applied to the Bucket, overtime, can be very large and hard to manage.
(+) One solution is to used Access Point, where we can have more granular permission controls for users, it also has unique DNS address for network access.

![[Pasted image 20240826145206.png]]